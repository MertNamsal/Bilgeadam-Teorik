...
public class Test {
	...
	public void thread1Metod() {
		...
		synchronized (this) {
			...
			try {
				wait(); // wait ile biz diyoruzki ben uyuyucam lock'u teslim edebilir
	...
	public void thread2Metod() {
		...
		synchronized (this) {
			...
			notify();		//notify ile diyoruz ki bizim bu lock ile işimiz bitti isyen lock'u alıp çalışabilir.
